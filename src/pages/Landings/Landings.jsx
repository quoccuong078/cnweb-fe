  ...
  useEffect(() => {
    const fetchLandings = async () => {
      try {
        ...
        // --- TẠM THỜI TẮT API ĐỂ DÙNG DỮ LIỆU GIẢ ---
        // const res = await api.get("/api/superadmin/landings");
        // const data = res.data.data || [];
        // setLandings(data);

        // --- DỮ LIỆU GIẢ (MOCK DATA) ---
        // Giả lập độ trễ mạng 1 xíu cho giống thật
        await new Promise(resolve => setTimeout(resolve, 500)); 

        const mockData = [
          { 
            id: 1, 
            title: "Landing Page Giới Thiệu Sản Phẩm", 
            domain: "sanpham.vn", 
            slug: "gioi-thieu", 
            template: "Modern", 
            color: "blue", 
